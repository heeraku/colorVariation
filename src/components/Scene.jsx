...
export default function Scene(props) {
  const scene01wall = useTexture("./scenes/white.jpg");
  scene01wall.wrapS = scene01wall.wrapT = THREE.RepeatWrapping;
  scene01wall.repeat.set(3, 3);
  ...
  return (
    <>
      <mesh receiveShadow rotation={[0, 0, 0]} position={[0, 4, -10]}>
        <planeGeometry args={[30, 10]} />
        {props.scene === 1 && <meshStandardMaterial map={scene01wall} />}
      ...
      <mesh receiveShadow rotation={[-Math.PI / 2, 0, 0]} position={[0, -1, 0]}>
        ...
        {props.scene === 1 && (
          ...
          //   metalness={0.5}
          // />
          <meshStandardMaterial map={scene01floor} />
        )}
